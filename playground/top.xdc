...
set_property PACKAGE_PIN V20 [get_ports {din[7]}]
set_property PACKAGE_PIN R18 [get_ports {din[6]}]
set_property PACKAGE_PIN T17 [get_ports {din[5]}]
set_property PACKAGE_PIN V18 [get_ports {din[4]}]
set_property PACKAGE_PIN V22 [get_ports {din[3]}]
set_property PACKAGE_PIN P21 [get_ports {din[2]}]
set_property PACKAGE_PIN AA22 [get_ports {din[1]}]
set_property PACKAGE_PIN AB20 [get_ports {din[0]}]
set_property PACKAGE_PIN U20 [get_ports {dout[7]}]
set_property PACKAGE_PIN P17 [get_ports {dout[6]}]
set_property PACKAGE_PIN R17 [get_ports {dout[5]}]
set_property PACKAGE_PIN U19 [get_ports {dout[4]}]
set_property PACKAGE_PIN W22 [get_ports {dout[3]}]
set_property PACKAGE_PIN T22 [get_ports {dout[2]}]
set_property PACKAGE_PIN P20 [get_ports {dout[1]}]
set_property PACKAGE_PIN Y20 [get_ports {dout[0]}]
